...
import com.swivel.crypto.CryptoConstants.Companion.IV_SEPARATOR
...
class CipherWrapper(val transformation: String) {
    ...
    private val cipher: Cipher = Cipher.getInstance(CipherTransformationType.TRANSFORMATION_SYMMETRIC.type)
