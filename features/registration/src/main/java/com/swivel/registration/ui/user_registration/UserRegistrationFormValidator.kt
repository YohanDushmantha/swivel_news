    ...
    fun validateFormData(
        ...
        userRegistrationFormData?.let {
            ...
            configResult.add(ValidNameConfig().apply {
                fieldName = context.getString(R.string.user_registration_form_label_firstName)
                text = it.firstName
                isRequired = true
            })

            configResult.add(ValidNameConfig().apply {
                fieldName = context.getString(R.string.user_registration_form_label_lastName)
                text = it.lastName
                isRequired = true
            })

            configResult.add(ValidEmailConfig().apply {
                fieldName = context.getString(R.string.user_registration_form_label_email)
                text = it.email
                isRequired = true
